...
import codecs
"""Automatic Cerebrum c code generator, this one being MSP-flavored"""
...
const char auto_config_descriptor[] = {${desc}};
"""
...
def generate(desc, device, devicename, builddate):
	...
	return desc, os.path.join(os.path.dirname(__file__), 'main')

def commit(device, args):
	"""Flash the newly generated firmware onto the device"""
	make_env = os.environ.copy()
	make_env["SERIAL"] = args.usbserial
