...
int main(void){
    ...
    TA1CTL = MC_2 | TASSEL_2; //Continous with SMCLK
		...
		// OUTMOD_7 inverts the PWM output such that e.g. 0xffff means 100% color
		// intensity
    TA0CCTL1 = OUTMOD_7;
    TA1CCTL1 = OUTMOD_7;
    TA1CCTL2 = OUTMOD_7;
    ...
    for(;;){
        ...
        TA1CCR1 = gammatable[rgb.b]; // blue
				...
				// TA0CCR1 = 0x0000; // green
				// TA1CCR1 = 0x0000; // blue, 0x0 = 100%
				// TA1CCR2 = 0x0000;
